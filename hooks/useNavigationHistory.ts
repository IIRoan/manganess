...
export const useNavigationHistory = () => {
    ...
    const handleBackPress = useCallback(async (gestureType: 'tap' | 'swipe' = 'tap') => {
        try {
            const previousRoute = await navigationService.getPreviousRoute(pathname);
            
            // Record gesture usage
            await navigationService.recordGestureUsage(gestureType === 'swipe' ? 'swipeBack' : 'tapBack');
