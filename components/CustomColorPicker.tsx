...
import {
    ...
    FlatList, Platform, SafeAreaView, Dimensions
} from 'react-native';
...
const COLORS = [
    ...
    {
        category: 'Yellows & Oranges', items: [
...
const CustomColorPicker: React.FC<CustomColorPickerProps> = ({
    visible, onClose, onColorSelected, initialColor, colors
}) => {
    ...
    const selectedColorName =
        COLORS.flatMap(cat => cat.items).find(item => item.color === selectedColor)?.name ||
        'Custom';
            ...
            <SafeAreaView style={styles.container}>
                <View style={[styles.modal, { backgroundColor: colors.card }]}>
                                ...
                                <View style={styles.colorGrid}>
                                    {category.items.map((colorItem) => (
                                        ...
                                        >
                                            ...
                                            <Text
                                                style={[styles.colorName, { color: colors.secondaryText }]}
                                                numberOfLines={1}
                                            >
                                                {colorItem.name}
                                            </Text>
                    ...
                    <View style={[styles.actions, { borderTopColor: colors.border }]}>
                        ...
                        >
                            <Text style={[styles.buttonText, { color: getContrastText(selectedColor) }]}>
                                Apply
                            </Text>
                        </TouchableOpacity>
                    </View>
